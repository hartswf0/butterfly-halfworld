...
| | | |
|---|---|---|
| **01** | OUT OF LIFE | the maze, the haze, the fall, the ember |
| **02** | FLASHING LIGHTS | the scream that travels inward |
| **03** | HOW TO BREAK OFF AN ENGAGEMENT | the storm takes everything that was ever called goods |
| **04** | NEVERMORE | a trail followed twice, a body reclaimed |
| **05** | BLOODLINES | asking permission to own the sky |
| **06** | RESURRECTING ATLANTIS | a city comes up out of the water |
| **07** | DJ TURN ME UP | amplitude, and eleven petals |
| **08** | NEWLY SINGLE | a soul leaves a body and is sent somewhere hotter |
| **09** | YET, HEARD | three calls before leaving |
| **10** | MAGIC RIDE | night replaced by morning, dot by dot |
| **11** | NEW DAY | the temple assembles, one course at a time |
| **12** | REUNION | less time for words, more space for laughter |
| **13** | HOW TO WIN MY HEART | orbits, close and counted |
| **14** | HOT MINUTE | everything learns to be weather, then a door |
