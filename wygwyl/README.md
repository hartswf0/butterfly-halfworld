...
| | | | mv | |
|---|---|---|---|---|
| **00** | [WHERE YOU GO WHEN YOU LEAVE](00-title-a.html) | the rosette — a differential-phase field resolving into type | 4 | 35s |
| **00** | [WHERE YOU GO WHEN YOU LEAVE](00-title-b.html) | the arabesque — nested rings, counter-rotating, collapsing inward | 3 | 34s |
| **00** | [WHERE YOU GO WHEN YOU LEAVE](00-title-c.html) | the catalogue — a grid of lissajous cells locking to letters | 3 | 33s |
