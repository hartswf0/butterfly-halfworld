...
`cut/out/archigram` · `cut/archigram.py` · 1.7MB
...
`cut/out/arspoetica` · `cut/arspoetica_site.py` · 133.0MB
...
`cut/out/bind` · `cut/bind.py` · 306.0KB
...
`cut/out/churn` · `cut/churn.py` · 1.1GB
...
`cut/out/collage` · `cut/collage.py` · 10.0MB
...
`cut/out/dress` · `cut/dress.py` · 7.9MB
...
`cut/out/elements` · `cut/parts.py` · 1.1GB
...
`cut/out/footage` · `cut/leads.py` · 194.8MB
...
`cut/out/harvest` · `cut/harvest.py` · 795.0MB
...
`cut/out/harvest_flow` · `cut/harvest.py` · 812.1MB
...
`cut/out/inhabit` · `cut/inhabit.py` · 6.8MB
...
`cut/out/journeys` · `cut/journeys.py` · 393.0MB
...
`cut/out/lab` · `cut/lab_site.py` · 977.8KB
...
`cut/out/loom` · `cut/loom.py` · 15.8MB
...
`cut/out/lucier` · `cut/lucier.py` · 4.5MB
...
`cut/out/moussa` · `cut/moussa.py` · 1.1GB
...
`cut/out/music` · `cut/music.py` · 11.3MB
...
`cut/out/parts` · `cut/parts.py` · 7.2MB
...
`cut/out/partswap` · `cut/partswap.py` · 143.3KB
...
`cut/out/patchfield` · `cut/patchfield.py` · 2.8MB
...
`cut/out/previs` · `cut/previs.py` · 5.0MB
...
`cut/out/quilt` · `cut/quilt.py` · 2.7MB
...
`cut/out/scene` · `cut/scene.py` · 4.0MB
...
`cut/out/sheets` · `cut/cutsheet.py` · 1.3MB
...
`cut/out/shorts` · `cut/shorts.py` · 923.1MB
...
`cut/out/sound` · `cut/soundcollage.py` · 144.4MB
...
`cut/out/textule` · `cut/patchfield.py` · 955.4KB
...
### MARKOV_POET — 77 moving

`MARKOV_POET/videos` · 239.6MB
...
`cut/out/beflix_e` · `cut/beflix_e.py` · 27.3MB
...
`cut/out/thumbs` · `cut/build_db.py` · 2.8MB
