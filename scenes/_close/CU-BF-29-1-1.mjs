...
const ENV_HZ = 50;
const ENV = [0,0.01,0,0,0.01,0.01,0.01,0,0.01,0.01,0.01,0.05,0.61,1.02,1.13,1.01,0.91,1,0.97,0.91,1,0.95,0.84,0.87,0.71,0.57,0.6,0.92,1.09,1.07,1.16,1.15,1.1,1.18,1.1,1.02,0.91,0.95,1,1.07,1.2,1.03,0.95,0.52,0.43,0.88,0.87,0.88,0.83,0.72,0.52,0.27,0.65,0.82,0.77,0.6,0.56,0.52,0.35,0.31,0.08,0.02,0.01,0.01,0.01,0,0,0,0.01,0.01,0,0];
const TRACK = [[0,0.119,"EE"],[0.119,0.161,"REST"],[0.161,0.263,"RR"],[0.263,0.382,"EE"],[0.382,0.448,"MM"],[0.448,0.568,"EE"],[0.568,0.633,"MM"],[0.633,0.753,"EE"],[0.753,0.855,"RR"],[0.855,0.974,"EE"],[0.974,1.034,"DD"],[1.034,1.075,"REST"],[1.075,1.195,"EE"],[1.195,1.255,"DD"],[1.255,1.446,"REST"]].map(([t0, t1, v]) => ({ t0, t1, v }));
