...
const ENV_HZ = 50;
const ENV = [0.01,0.01,0.01,0.01,0,0.01,0.01,0.01,0.01,0.01,0.01,0.02,0.01,0.01,0.03,0.91,1.35,1.29,1.09,0.59,0.12,0.03,0.16,0.31,0.71,0.94,1.14,0.86,0.3,0.03,0.06,0.19,0.21,0.12,0.14,0.49,0.67,0.55,0.46,0.42,0.31,0.23,0.16,0.03,0.02,0.17,0.57,1,0.62,0.16,0.26,0.38,0.34,0.12,0.09,0.06,0.04,0.06,0.07,0.09,0.08,0.08,0.05,0.01,0.01,0.01,0.01,0.01,0.01,0,0.01,0.01,0.01,0.01];
const TRACK = [[0,0.114,"EE"],[0.114,0.172,"DD"],[0.172,0.211,"REST"],[0.211,0.326,"OO"],[0.326,0.44,"EE"],[0.44,0.497,"DD"],[0.497,0.537,"REST"],[0.537,0.594,"DD"],[0.594,0.709,"EE"],[0.709,0.766,"DD"],[0.766,0.806,"REST"],[0.806,0.92,"EE"],[0.92,0.977,"DD"],[0.977,1.052,"SS"],[1.052,1.166,"EE"],[1.166,1.223,"DD"],[1.223,1.303,"FF"],[1.303,1.486,"REST"]].map(([t0, t1, v]) => ({ t0, t1, v }));
