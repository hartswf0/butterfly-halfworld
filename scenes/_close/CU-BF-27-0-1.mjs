...
const ENV_HZ = 50;
const ENV = [0.01,0.01,0.01,0.01,0,0.01,0,0.01,0.01,0.01,0.02,0.02,0.36,1.35,1.35,1.35,1.35,1.35,1.35,1.35,1.35,1.32,1.25,1.12,1.07,1.08,0.77,0.54,0.61,0.92,1.27,1.35,1.35,1.35,1.27,0.33,0.66,1.35,1.33,1.04,0.59,0.04,0.03,0.02,0.01,0.01,0.12,0.75,1.18,1.16,0.87,0.65,0.5,0.42,0.41,0.55,0.55,0.17,0.06,0.05,0.03,0.03,0.02,0.01,0.01,0.01,0.01,0.01,0.01];
const TRACK = [[0,0.133,"OO"],[0.133,0.265,"EE"],[0.265,0.311,"REST"],[0.311,0.444,"OO"],[0.444,0.59,"OH"],[0.59,0.656,"DD"],[0.656,0.702,"REST"],[0.702,0.835,"EE"],[0.835,0.901,"DD"],[0.901,0.948,"REST"],[0.948,1.02,"MM"],[1.02,1.153,"EE"],[1.153,1.365,"REST"]].map(([t0, t1, v]) => ({ t0, t1, v }));
