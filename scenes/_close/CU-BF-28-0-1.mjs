...
const ENV_HZ = 50;
const ENV = [0,0,0.01,0,0.01,0,0,0,0,0,0,0.01,0.62,0.98,1.17,1.22,1.3,1.29,1.21,0.98,0.34,0.06,0.05,0.51,0.23,0.21,1.09,1.16,1.1,0.97,0.93,0.9,0.81,0.6,0.71,0.92,1.12,1.17,0.94,0.93,0.87,0.98,0.83,0.63,0.39,0.18,0.05,0.02,0.01,0.01,0,0.01,0,0,0,0.01,0.01,0,0,0];
const TRACK = [[0,0.103,"EE"],[0.103,0.215,"OH"],[0.215,0.251,"REST"],[0.251,0.318,"SS"],[0.318,0.431,"OH"],[0.431,0.487,"MM"],[0.487,0.59,"EE"],[0.59,0.626,"REST"],[0.626,0.728,"REST"],[0.728,0.831,"EE"],[0.831,0.918,"RR"],[0.918,1.021,"EE"],[1.021,1.185,"REST"]].map(([t0, t1, v]) => ({ t0, t1, v }));
